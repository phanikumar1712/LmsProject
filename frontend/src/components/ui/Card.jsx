...
export const Card = React.memo(function Card({ children, className = '', noPadding = false, accentColor, onClick, title }) {
...
export const CardHeader = React.memo(function CardHeader({ title, icon, right, className = '' }) {
    return (
...
export const MetricRow = React.memo(function MetricRow({ label, value, valueClassName = '' }) {
    return (
