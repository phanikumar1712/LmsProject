...
export const Spinner = React.memo(function Spinner({ size = 'md', className = '' }) {
...
export const LoadingContainer = React.memo(function LoadingContainer({ height = 'h-64', size = 'md' }) {
    return (
...
export const EmptyState = React.memo(function EmptyState({ icon: Icon, message, action, className = '' }) {
    return (
...
export const Badge = React.memo(function Badge({ variant = 'neutral', children, className = '' }) {
    const variants = {
