    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 bg-background border-b border-border shadow-sm h-16 flex items-center transition-all">
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6">
                        ...
                        {!isAuthenticated ? (
                            ...
                            <div className="flex items-center gap-5">
                                ...
                                <div className="relative" ref={notifRef}>
                                    ...
                                    {notifOpen && (
                                        <div className="absolute right-0 top-10 w-[calc(100vw-2rem)] max-w-xs sm:max-w-sm sm:w-80 bg-popover border border-border rounded-2xl shadow-2xl py-2 z-50 overflow-hidden transform origin-top-right transition-all">
                ...
                {menuOpen && (
                    <div className="md:hidden fixed top-16 left-0 right-0 bottom-0 bg-background border-b border-border shadow-2xl py-4 px-4 flex flex-col gap-4 z-50 overflow-y-auto scrollbar-thin">
                        ...
                        {isAuthenticated && (
                            <div className="flex items-center gap-3 pb-4 pt-2 border-b border-border">
                                ...
                                <div className="flex-1 min-w-0">
                                    <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60 block">Signed in as</span>
                                    <p className="text-base font-bold text-foreground leading-tight truncate">{user?.name}</p>
                        ...
                        <div className="flex flex-col gap-1">
                            <Link to="/courses" className="text-base font-bold text-foreground/80 px-2 py-3 rounded-xl hover:bg-muted/40 transition-colors">Explore Catalog</Link>
                            {isAuthenticated ? (
                                <>
