                            ...
                            <div key={course.id} className="bg-muted/40 border border-border p-5 rounded-2xl flex flex-col md:flex-row gap-6 items-center hover:bg-muted transition-colors relative group shadow-sm">
                                ...
                                <div className="flex-1">
                                    <div className="flex items-start justify-between mb-3">
                                        <div>
                                            <h3 className="text-lg font-bold text-foreground mb-1"><Link to={`/courses/${course.id}`} className="hover:text-indigo-600 transition-colors">{course.title}</Link></h3>
                                ...
                                <div className="flex flex-col items-end gap-3 flex-shrink-0 w-36 border-l border-border pl-6">
                                    <div className="w-full">
                                        ...
                                        {course.status === 'DRAFT' && <span className="bg-muted text-muted-foreground border border-border shadow-sm text-[11px] font-bold px-3 py-1.5 rounded-lg w-full text-center">Draft</span>}
                                    </div>
